...
Form::AlreadySignedFormException::AlreadySignedFormException() : exception() {}
Form::AlreadySignedFormException::AlreadySignedFormException(const AlreadySignedFormException&) : exception() {}
Form::AlreadySignedFormException::~AlreadySignedFormException() _NOEXCEPT {}
const char* Form::AlreadySignedFormException::what() const _NOEXCEPT {
	return ("AlreadySignedFormException");
}

Form::NotSignedFormException::NotSignedFormException() : exception() {}
Form::NotSignedFormException::NotSignedFormException(const NotSignedFormException&) : exception() {}
Form::NotSignedFormException::~NotSignedFormException() _NOEXCEPT {}
const char* Form::NotSignedFormException::what() const _NOEXCEPT {
	return ("NotSignedFormException");
}
